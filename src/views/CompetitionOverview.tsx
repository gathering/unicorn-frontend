    ...
    return (
        <View>
            {user && plausibleAutogeneratedNick && (
                <section
                    className="mx-auto mt-4 ml-10 max-w-prose border-l-4 border-yellow-500 bg-yellow-100 px-3 py-4 text-yellow-700"
                    role="alert"
                >
            ...
            <div className="flex flex-row sm:flex-col">
                <aside className="mx-10 mt-12 flex flex-col sm:m-4">
                    <Input
                        className="mb-6 sm:mb-2 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:focus:bg-gray-900"
                        placeholder="Search"
                        value={search}
                        ...
                        {filteredCompetitions.map((competition) => (
                            ...
                            >
                                <Link to={"/competitions/" + competition.id} className="flex h-32">
                                    ...
                                    <div className="flex rounded-r bg-white pr-4 md:hidden sm:hidden dark:bg-gray-800 dark:text-gray-200">
                                        <svg
